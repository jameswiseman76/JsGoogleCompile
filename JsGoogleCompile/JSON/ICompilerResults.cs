// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ICompilerResults.cs" company="www.jameswiseman.com">
...
// </copyright>
// <summary>
//     Interface for compiler results emitted by the Google Closure Compiler
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JsGoogleCompile
{
    ...
    public interface ICompilerResults
    {
        ...
        /// </summary>
        List<CompilerError> Errors { get; set; }

        /// <summary>
        /// Gets or sets the list of warnings that occurred.
        /// </summary>
        List<CompilerError> Warnings { get; set; }

        /// <summary>
        /// Gets or sets the statistics.
        /// </summary>
        CompilerStatistics Statistics { get; set; }
        ...
        /// </param>
        void SupressWarningsFrom(IList<string> supressedWarnings);
        ...
        void Emit(IList<IResultsOutput> resultsEmitters);
    }
}
