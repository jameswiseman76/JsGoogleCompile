// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompilerStatistics.cs" company="www.jameswiseman.com">
...
// </copyright>
// <summary>
//     Class to wrap compiler staistics emitted by the Google Closure Compiler
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace JsGoogleCompile
{
    ...
    public class CompilerStatistics
    {
        ...
        /// <summary>
        /// Gets or sets the original g-zip size.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the compressed g-zip size.
        /// </summary>
